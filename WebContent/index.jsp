...
<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
				<div class="navbar-header">
					<a class="navbar-brand" href="http://www.zjut.edu.cn/">ZJUT</a>
					<img src="./img/logo.png" style="margin-top:10px" width="30" height="30" />
				</div>
...
<div class="jumbotron" style="margin-top: 50px;">
	...
	<div class="container">
		<h1 class="animated fadeInDown ">高效 快捷</h1>
		<p class="animated fadeInRightBig">浙江工业大学二维码签到程序 登录入口</p>
...
<div class="container">
	<h4>浙江工业大学</h4>
	<p>Designed and built by <a href="http://www.zjut.edu.cn/" target="_blank">@ZJUT</a></p>	
 </div>
 </div> 
</footer>
