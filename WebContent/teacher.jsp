...
<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
				<div class="navbar-header">
					<a class="navbar-brand" href="#">ZJUT</a>
				</div>
		...
		<div class="col-lg-9" id="teacher_con">
			...
			<div id="div_set" >
					<table class="table">
						...
						<tr>
							<td>二维码接口地址</td>
							<td><input type="text"  class="form-control"  name="" id="txtCode" value="http://qr.liantu.com/api.php?text="/></td>
							<td></td>
						</tr>
...
<div class="container">
	<h4>浙江工业大学</h4>
	<p>Designed and built by <a href="#" target="_blank">@ZJUT</a></p>	
 </div>
 </div> 
</footer>
